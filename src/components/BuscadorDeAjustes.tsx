...
export const AJUSTES: Ajuste[] = [
    ...
    { id: 'mecanico', titulo: 'Quién hizo cada service', tab: 'preferencias', palabras: 'mecanico mecanicos empleado empleados quien hizo comision equipo metricas por persona' },
    ...
    { id: 'avisos_suaves', titulo: 'Avisos de «vale una llamada»', tab: 'preferencias', palabras: 'primer service no volvio clientes perdidos llamar retencion avisos' },
