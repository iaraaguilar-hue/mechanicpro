...
export const AJUSTES: Ajuste[] = [
    ...
    { id: 'menu', titulo: 'Menú de services y precios', tab: 'servicios', palabras: 'services servicios precios precio lista de precios catalogo agregar service desactivar tipos se repite repeticion cada cuanto meses volver a hacer recordar lavado lubricacion' },
    ...
    { id: 'avisos_suaves', titulo: 'Avisos de "vale una llamada"', tab: 'preferencias', palabras: 'primer service no volvio clientes perdidos llamar retencion avisos frecuentes clientes de siempre activos invitar service agregar aviso nuevo aviso propio repetir service cada cuanto lavado lubricacion periodicidad recordar volver a hacer' },
